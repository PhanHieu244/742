...
namespace SgLib
{
    public class ScreenshotSharer : MonoBehaviour
    {
        ...
        #if !EASY_MOBILE_PRO
        [HideInInspector]
        private SharedImageType sharedImageFormat = SharedImageType.PNG;
        #else
        ...
        void OnEnable()
        {
            UIManager.RequestShare += CaptureScreenShot;
            UIManager.RecordGame += RecordGame;
        }
        ...
        public void CaptureScreenShot(bool isStop)
        {
